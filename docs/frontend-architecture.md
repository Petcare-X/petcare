...
- UI primitives: `shadcn/ui` или аналогичный набор поверх `Radix UI` [ДОПУЩЕНИЕ]
- Иконки: `lucide-react` или аналогичный lightweight icon set [ДОПУЩЕНИЕ]

### 3.4 Интеграции
- HTTP-клиент: `fetch` wrapper или `axios`
- Карты: `MapLibre GL JS` или `Leaflet`
...
- `entities/` содержит доменные типы, адаптеры и small reusable pieces around business entities.
...
- Info: `#3D6EA8`
- Neutral text: `#24323D`
- Neutral surface: `#FFFDFC`

### 16.2 Типографика
- Основной шрифт: `Manrope` или `Inter`
- Акцентный шрифт для крупных заголовков: `Fraunces` или `Merriweather Sans` [ДОПУЩЕНИЕ]

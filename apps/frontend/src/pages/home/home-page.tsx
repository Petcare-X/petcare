        ...
        <>
            ...
            <section className="services-section">
                ...
                <ul className="services-list">
                    <li>
                        <Link className="service-card" to={appRoutes.map} search={{ filter: "place"}}>
                    ...
                    <li>
                        <Link className="service-card" to={appRoutes.map} search={{ filter: "clinic"}}>
                            <svg className="service-icon" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <Link className="service-card" to={appRoutes.map} search={{ filter: "salon"}}>
                            <svg className="service-icon" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">

...
function MapCanvas({ onBack }: MapCanvasProps) {
    return (
        <section className="map-stage" aria-label="Карта мест">
            <button type="button" className="map-back-button" aria-label="Вернуться назад" onClick={onBack}>
        ...
        <li className="place-item">
            <div className="place-copy">
                ...
                <div className="place-actions" aria-label={`Действия для ${place.title}`}>
                    <button type="button" className="place-action" aria-label="Открыть сайт">
                        <GlobeIcon />
                    </button>
                    <button type="button" className="place-action" aria-label="Позвонить">
                        <PhoneIcon />
                    </button>
                </div>
            </div>
...
export function MapPage() {
    ...
    const [activeFilter, setActiveFilter] = useState<PlaceType>("clinic");
    const [sheetHeight, setSheetHeight] = useState(SHEET_HALF);
    ...
    return (
        <div className="map-page">
            <MapCanvas onBack={() => navigate({ to: "/home" })} />
            ...
            >
                ...
                <label className="places-search">
                    ...
                    <input type="search" placeholder="ПОИСК И ВЫБОР МЕСТ" />
                </label>

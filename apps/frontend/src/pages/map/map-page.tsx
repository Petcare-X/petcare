...
//     return (
//         <YMap location={reactify.useDefault({ center, zoom })}>
//             <YMapDefaultSchemeLayer />
//             <YMapDefaultFeaturesLayer />
//             {points.map((point) => (
//                 <YMapMarker
//                     key={point.id}
//                     coordinates={reactify.useDefault(point.coordinates, [point.coordinates])}
//                 >
//                     <button className={`custom-marker custom-marker-${point.kind}`}>
//                         {point.title}
//                     </button>
//                 </YMapMarker>
//             ))}
...
//             <MapCanvas onBack={() => navigate({ to: appRoutes.home })} />
